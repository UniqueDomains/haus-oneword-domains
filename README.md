# Available .HAUS One-Word Domains (11,838)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-11%2C838%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **11,838 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 11,838 domains · **Median ask:** $27.80 · **High-demand under $2,500:** 0
...
| tea.haus   | premium   | $854      | $854          | high           | low    | 3      | namesilo            |
...
| NWO.haus   | available | $19.99    | —             | medium         | low    | 3      | name.com            |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 11,838 live domains                        |
...
> Unique Domains. *Available .HAUS One-Word Domains*. Version 2026-07-07. Public GitHub extract for the exact Unique Domains search represented by this repository.

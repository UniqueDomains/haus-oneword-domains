...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C879%20rows-8250df">
...
**Public extract:** 8,879 rows · **Live catalog:** 8,879 domains
...
- `haus.csv` — public CSV extract (8,879 rows)
- `haus.json` — public JSON extract (8,879 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,879-row public sample | 8,879 live domains                               |
...
> Unique Domains. *Available .HAUS One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.

# Available .HAUS One-Word Domains (24,389)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-24%2C389%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **24,389 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 24,389 domains · **Median ask:** $18.43 · **High-demand under $2,500:** 3
...
| web.haus   | premium   | $854      | $854          | medium         | medium | 3      | namesilo            |
...
| pizza.haus | resell    | —         | —             | medium         | medium | 5      | united-domains GmbH |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 24,389 live domains                        |
...
> Unique Domains. *Available .HAUS One-Word Domains*. Version 2026-09-17. Public GitHub extract for the exact Unique Domains search represented by this repository.
